...
<?php $__env->startSection('title', 'Ver Orden del Día'); ?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('ordenes.index')); ?>">Ordenes del Día</a></li>
                        ...
                        <div class="col-md-6">
                            <div class="info-box bg-light">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e(\Carbon\Carbon::parse($orden->fecha)->format('d/m/Y')); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-box bg-light">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($orden->user->name ?? 'Sistema'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <div class="btn-group ml-2" role="group">
                                ...
                                <a href="<?php echo e(route('ordenes.index')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted"><?php echo e($orden->created_at->format('d/m/Y H:i:s')); ?></p>
                        </div>
                        <div class="col-md-6">
                            <strong>Última actualización:</strong>
                            <p class="text-muted"><?php echo e($orden->updated_at->format('d/m/Y H:i:s')); ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <strong>ID del documento:</strong>
                            <p class="text-muted">#<?php echo e(str_pad($orden->id, 6, '0', STR_PAD_LEFT)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Nombre:</strong> <?php echo e($orden->nombre); ?></p>
                <p class="text-danger"><strong>Esta acción no se puede deshacer.</strong></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <form action="<?php echo e(route('ordenes.destroy', $orden)); ?>" method="POST" style="display: inline;">
                    <?php echo csrf_field(); ?>
...
function printDocument() {
    ...
    const documentName = '<?php echo e($orden->nombre); ?>';
    const fecha = '<?php echo e(\Carbon\Carbon::parse($orden->fecha)->format("d/m/Y")); ?>';
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\integrador\resources\views/ordenes/show.blade.php ENDPATH**/ ?>