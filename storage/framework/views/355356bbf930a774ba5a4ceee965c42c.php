...
<?php $__env->startSection('title', 'Editar Orden del Día'); ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('ordenes.index')); ?>">Órdenes del Día</a></li>
    ...
    <div class="col-12">
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-edit"></i> Editando: <?php echo e($orden->nombre); ?>

                </h3>
                <div class="card-tools">
                    <a href="<?php echo e(route('ordenes.show', $orden)); ?>" class="btn btn-info btn-sm">
                        <i class="fas fa-eye"></i> Ver
                    </a>
                    <a href="<?php echo e(route('ordenes.index')); ?>" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left"></i> Volver
                    </a>
                </div>
            </div>
            
            <form action="<?php echo e(route('ordenes.update', $orden)); ?>" method="POST" id="ordenEditForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('nombre', $orden->nombre)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('fecha', $orden->fecha)); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>" 
                                  rows="15" 
                                  required><?php echo e(old('contenido', $orden->contenido)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?php echo e(route('ordenes.show', $orden)); ?>" class="btn btn-info">
        ...
        <div class="card card-secondary">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <strong>Creado:</strong> <?php echo e($orden->created_at->format('d/m/Y H:i:s')); ?><br>
                        <strong>Última actualización:</strong> <?php echo e($orden->updated_at->format('d/m/Y H:i:s')); ?>

                    </div>
                    <div class="col-md-6">
                        <strong>ID del documento:</strong> <?php echo e($orden->id); ?><br>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Vista Previa - <?php echo e($orden->nombre); ?></h5>
        ...
        <html>
            ...
            <body>
                ...
                <div class="footer">
                    ...
                    <p>ID del documento: <?php echo e($orden->id); ?></p>
                </div>
            </body>
        </html>
    `;
...
setInterval(function() {
    const contenido = tinymce.get('editor').getContent();
    if (contenido.trim()) {
        localStorage.setItem('orden_edit_<?php echo e($orden->id); ?>', JSON.stringify({
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\integrador\resources\views/ordenes/edit.blade.php ENDPATH**/ ?>