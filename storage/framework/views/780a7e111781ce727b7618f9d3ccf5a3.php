...
<?php $__env->startSection('title', 'Nueva Orden del Día'); ?>
...
<div class="row">
    <div class="col-12">
        <div class="card card-primary">
            ...
            <form action="<?php echo e(route('ordenes.store')); ?>" method="POST" id="ordenForm">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <?php if($errors->any()): ?>
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <input type="hidden" name="contenido_backup" id="contenido_backup" value="<?php echo e(old('contenido')); ?>">
...
function verificarConectividad() {
    return fetch('<?php echo e(route("ordenes.index")); ?>', {
        method: 'HEAD',
        cache: 'no-cache'
    }).then(response => {
        return response.ok;
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\integrador\resources\views/ordenes/create.blade.php ENDPATH**/ ?>